...
#define NFC_MISO_Pin GPIO_PIN_1
...
#define NFC_MOSI_Pin GPIO_PIN_4
#define NFC_MOSI_GPIO_Port GPIOC
#define NFC_NSS_Pin GPIO_PIN_13
#define NFC_NSS_GPIO_Port GPIOB
#define NFC_SCK_Pin GPIO_PIN_11
