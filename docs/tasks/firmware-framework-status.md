...
- STM32 base now links LittleFS, RC522 BSP/platform support and the local attendance app modules: `attendance_app`, `att_card`, `att_crc16`, `att_lfs_port`, `att_storage` and `att_protocol`.
...
- ESP01S application modules are not yet linked into the STM32 base Makefile.
